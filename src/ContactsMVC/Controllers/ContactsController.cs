...
namespace ContactsMVC.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        //--------------------------------------------------------------------------------------------------------------
        public ContactsController(IBusinessServices businessServices, IOptions<UISettings> uiSettings)
        {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("ID,FirstName,LastName,CompanyID,ContactTypeID")] ContactDetailsViewModel contactDetailsViewModel)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    return RedirectToAction("Details", "Contacts", new RouteValueDictionary() { { "id", contactDetailsViewModel.ID } });
                }
