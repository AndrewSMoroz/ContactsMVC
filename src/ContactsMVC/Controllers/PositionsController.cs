...
namespace ContactsMVC.Controllers
{
    ...
    public class PositionsController : Controller
    {
        ...
        //--------------------------------------------------------------------------------------------------------------
        public PositionsController(IBusinessServices businessServices, IOptions<UISettings> uiSettings)
        {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("ID,CompanyID,Title,Description,DatePosted,ContactIDs")] PositionDetailsViewModel positionDetailsViewModel)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    return RedirectToAction("Details", "Positions", new RouteValueDictionary() { { "id", positionDetailsViewModel.ID } });
                }
