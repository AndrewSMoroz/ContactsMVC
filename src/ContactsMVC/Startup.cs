...
namespace ContactsMVC
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddOptions();                                                      // Adds functionality to inject IOptions<T>
            services.Configure<UISettings>(Configuration.GetSection("UISettings"));     // Registers UISettings object so it can be injected
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, ContactsDbContext contactsDbcontext)
        {
            ...
            {
                app.UseExceptionHandler("/Positions/Error");
            }
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(name: "default", template: "{controller=Positions}/{action=Index}/{id?}");
            });
